# Introduction
Vectis is a new Apple Music client designed from the ground up to be user friendly and feature packed.

# Features
- [x] Basic Apple Music Support
- [ ] Lyrics Support (Both portrait and Landscape)
- [ ] Last.FM Integration
- [ ] Sound Processing (Loudness, EQ, etc)
- [ ] Animated Artwork
- [ ] Discord Rich Presence
- [ ] CarPlay Support
- [ ] MusicMatch for songs with no lyrics on Apple

# Vision
Vectis is planned to be cross platform similar to spotify, including integrated remote control features. We plan to offer 
